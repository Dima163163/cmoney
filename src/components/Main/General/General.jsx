        ...
        loading ? (
          ...
          <>
            <div className={style.hero}>
              <h1 className={style.hero__title}>Hello, developer!</h1>
              <button
            ...
            <div className={style.accounts__title_wrapper}>
              ...
              <div className={style.accounts__sort}>
                ...
                <select
                  className={style.accounts__select}
            ...
            <ul className={style.accounts__list}>
              {
                accounts.map(data => (
                  <li
                    key={data.account}
                    className={style.accounts__item}
                    ...
                    <div className={style.accounts__date_wrapper}>
                      ...
                      <div className={style.accounts__date}>
                        ...
                        </p>
                        {
                          ...
                          (
                            <time
                              className={style.accounts__date_last}
