    ...
    <table className={style.transactions_table}>
      <thead className={style.table_header}>
        <tr className={style.table_header_row}>
          <th
            className={cn(style.table__cell, style.table__cell_account)}
          >
            Счет
          </th>
      ...
      <tbody className={style.table_body}>
        {[...transactions].map((data, i) => (
          <tr key={i} className={style.table_row}>
            ...
            >
              {
                data.form === account ? (data.to) : (data.from)
              }
            </td>
            <td
              className={data.form === account ?
              style.minus : style.table__cell_sum}
            >
              {data.amount}
            </td>
            <td
              className={cn(style.table__cell, style.table__cell_date)}
            >
